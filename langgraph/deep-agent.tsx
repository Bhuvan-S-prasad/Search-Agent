...
// -----------------------------------------------------------
// Define the Google Custom Search tool
// -----------------------------------------------------------
...
const googleSearch = tool(
    async ({ query }: { query: string }) => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/google-search-api`, {
                method: 'POST',
                headers: {
            ...
            // Transform Google Custom Search API response to a more usable format
    ...
    {
        name: "google_search",
        description: "Search the web using Google Custom Search. Returns titles, links, and snippets from search results.",
        schema: z.object({
...
// -----------------------------------------------------------
// Define the main research deep agent
// -----------------------------------------------------------
...
Use this to run a Google search for a given query. Returns web search results with titles, links, and snippets.
`;
...
const main = async () => {
  const config = {recursionLimit: 1000}
